...
public class stand extends JPanel {
    private BufferedImage spriteSheet;
    private int currentFrame = 0;
    private int frameWidth, frameHeight;
    private int numFrames = 3; // Số lượng khung hình trong sprite sheet
    private int frameDelay = 350; // Độ trễ giữa các khung hình (milliseconds)
    private long lastFrameTime;

    public stand() {
        // Load sprite sheet
        ImageIcon icon = new ImageIcon("C:\\Users\\Admin\\Desktop\\JAVA\\BTL\\TÀI NGUYÊN\\character\\stand.png");
