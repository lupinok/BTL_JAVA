...
public class Chapter2 extends JPanel {
    ...
    private void addTitleLabel() {
        // Tạo nhãn văn bản
        JLabel titleLabel = new JLabel("CHAPTER 2");
    ...
    public void displayChapterInterface() {
        JFrame chapterFrame = new JFrame("Chapter 2"); // Thay X bằng số của chapter tương ứng
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Chapter2");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.getContentPane().add(new Chapter2());
            frame.pack();
