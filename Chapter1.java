...
public class Chapter1 extends JPanel {
    ...
    private void addTitleLabel() {
        // Tạo nhãn văn bản
        JLabel titleLabel = new JLabel("CHAPTER 1");
    ...
    public void displayChapterInterface() {
        JFrame chapterFrame = new JFrame("Chapter 1"); // Thay X bằng số của chapter tương ứng
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Chapter1");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.getContentPane().add(new Chapter1());
            frame.pack();
