...
class BagItem extends JPanel {
	...
	private JLabel quantityLabel; // Nhãn để hiển thị số lượng
	
	public BagItem(String itemName, String imagePath) {
        ...
        // Tạo và thêm nhãn để hiển thị số lượng
        ...
        add(quantityLabel, BorderLayout.NORTH);
    ...
    protected void paintComponent(Graphics g) {
        ...
        Image bgImage = bgIcon.getImage().getScaledInstance(getWidth(), getHeight(), Image.SCALE_FAST);
        ...
        int textWidth = fm.stringWidth(itemName); // Lấy chiều rộng của chữ
        ...
        g2d.drawString(itemName, x, y); // Vẽ chữ
