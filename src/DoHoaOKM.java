...
public class DoHoaOKM extends JFrame implements KeyListener {
    ...
    private Image character1ImageOKM; // Ảnh của nhân vật số 1
    private Image character2ImageOKM; // Ảnh của nhân vật số 2
    private int character1X = 100; // Vị trí x của nhân vật số 1
    private int character1Y = 590; // Vị trí y của nhân vật số 1
    ...
    public DoHoaOKM() {
        ...
        try {
            backGroundOKM = new ImageIcon("C:\\Users\\ADMIN\\Documents\\NetBeansProjects\\GiaoDienOKM\\src\\imagesOKM\\backGroundOKM.jpg").getImage();
            DiaHinhOKM = new ImageIcon("C:\\Users\\ADMIN\\Documents\\NetBeansProjects\\GiaoDienOKM\\src\\imagesOKM\\DiaHinhOKM.png").getImage();
            DaoTrenKhongOKM = new ImageIcon("C:\\Users\\ADMIN\\Documents\\NetBeansProjects\\GiaoDienOKM\\src\\imagesOKM\\DaoTrenKhongOKM.png").getImage();
            TenMapOKM = new ImageIcon("C:\\Users\\ADMIN\\Documents\\NetBeansProjects\\GiaoDienOKM\\src\\imagesOKM\\TenMapOKM.png").getImage();
            character1ImageOKM = new ImageIcon("C:\\Users\\ADMIN\\Documents\\NetBeansProjects\\GiaoDienOKM\\src\\imagesOKM\\BoyOKM.png").getImage(); // Load ảnh của nhân vật số 1
            character2ImageOKM = new ImageIcon("C:\\Users\\ADMIN\\Documents\\NetBeansProjects\\GiaoDienOKM\\src\\imagesOKM\\BossOKM.png").getImage(); // Load ảnh của nhân vật số 2
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void doDrawing(Graphics g) {
        ...
        g2d.drawImage(DaoTrenKhongOKM, 450, 150, 500, 350, this);
        // Vẽ ảnh Địa Hình
        ...
        g2d.drawImage(DiaHinhOKM, 0, 270, 1450, 580, this);
        ...
        if (isFacingLeft) {
            ...
            g2d.drawImage(character1ImageOKM, character1X + 150, character1Y, -150, 150, this);
        } else {
            // Nếu nhân vật đang hướng phải, vẽ bình thường
            g2d.drawImage(character1ImageOKM, character1X, character1Y, 150, 150, this);
        }
        ...
        // Vẽ nhân vật số 2
        g2d.drawImage(character2ImageOKM, character2X , character2Y, 140, 140, this);
